...
export const CONTRACTUAL_KEYWORDS_BY_RULE = {
  ...
  existing_report_fix: [
    ...
    'exibicao',
    'exibição',
    'visualizacao existente',
    'visualização existente',
    'correcao de relatorio',
...
export const IMPROVEMENT_KEYWORDS_BY_RULE = {
  new_feature: [
    ...
    'edicao manual',
    'edição manual',
    'campo flutuante de pesquisa',
    'botao flutuante',
    'botão flutuante',
    'separacao dos percentuais',
    'separação dos percentuais',
  ],
  analytics_and_bi: [
    'relatorio analitico',
    'relatório analítico',
